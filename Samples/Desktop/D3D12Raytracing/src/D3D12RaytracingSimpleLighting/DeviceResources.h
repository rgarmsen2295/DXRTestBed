...
namespace DX
{
    ...
    public:
        ...
        ID3D12Resource*             GetRenderTarget() const { return m_raytracingRenderTargets[m_backBufferIndex].Get(); }
    ...
    private:
        ...
        Microsoft::WRL::ComPtr<ID3D12Resource>              m_raytracingRenderTargets[MAX_BACK_BUFFER_COUNT];
